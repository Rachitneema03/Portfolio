...
export function Skills() {
  const skillsList = [
    ...
    { name: "PostgreSQL", icon: <Database size={24} className="stroke-[3]" />, color: "bg-white", rotate: "rotate-1" },
    { name: "Docker", icon: <Terminal size={24} className="stroke-[3]" />, color: "bg-violet", rotate: "-rotate-2" },
    { name: "AWS", icon: <Server size={24} className="stroke-[3]" />, color: "bg-yellow", rotate: "rotate-2" },
    ...
    { name: "Linux", icon: <Terminal size={24} className="stroke-[3]" />, color: "bg-yellow", rotate: "rotate-1" },
